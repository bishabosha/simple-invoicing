...
//> using scala 3.8.2
//> using files Layout.scala ScratchPdfRenderer.scala Logger.scala
...
val outputPath = args.headOption.getOrElse("ScratchInvoice.pdf")
  ...
  document(
    page()(
      ...
      table(label, body, style = Style(marginTop = 1.lh, marginBottom = 1.lh))(
        ...
        tr(td("Native PDF renderer spike"), td("15"), td("75,00"), td("1125,00")),
...
ScratchPdfRenderer.render(outputPath, doc)
Logger.info(s"Scratch PDF written to ${outputPath}")
